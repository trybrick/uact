/*!
 *  uact.js - v0.1.2
 *  build: Fri May 12 2017 17:35:50 GMT-0500 (CDT)
    ...
    value: function setupHandlers() {
      ...
      function actionHandler(e) {
        ...
        if (that._brxua) {
          ...
          var uae = { ea: evt.action, el: evt.label, ev: evt.value, ec: evt.category + '_' + wu.win.location.hostname, cb: new Date().getTime() };
